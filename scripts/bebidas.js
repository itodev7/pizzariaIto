...
var dolly =
{
    ...
    quantidade: 1 ,
    codigo: 7,
    imagem: "img/dolly-refrigerantes.jpg"
}
var fantaGuarana =
{
    nome: "Fanta Guarana" ,
...
var pitchula =
{
    ...
    quantidade: 1 ,
    codigo: 9,
    imagem: "img/pichula.jpeg"
}

bebidas.push(redBull)
bebidas.push(cocaCola)
bebidas.push(dolly)
bebidas.push(fantaGuarana)
bebidas.push(pitchula)
...
var quantidadeItens = 0;
    ...
    function adicionarBebida(codigo) 
    {
        let bebida = carrinho.find(p => p.codigo == codigo)
        if (bebida == undefined || bebida == null) 
        {
            bebida = bebidas.find(p => p.codigo == codigo)
            let bebidaCopia = {
                nome: bebida.nome,
                valor: bebida.valor,
    ...
    {
        let bebida = bebidas.find(x => x.codigo == codigo)

        if (bebida == undefined || bebida == null) 
        {
            alert("Esse bebida  não existe no nosso cardápio!")
            return;
        }
        ...
        {
            removerFavorito(bebida);
        }
        else 
        {
            adicionarFavorito(bebida);
        }
    }
